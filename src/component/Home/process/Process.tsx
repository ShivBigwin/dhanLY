...
const eligibilityCriteria = [
  {
    ...
    description: "Applicant should be minimum 21 years old.",
    ...
    <section className="relative py-12 bg-gradient-to-b from-blue-50 via-white to-gray-50 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          ...
          >
            Clear, streamlined steps designed to deliver intelligent financial
            solutions with ease.
          </motion.p>
        </motion.div>
          ...
          {solutions.map((solution, index) => (
            ...
            >
              ...
              <div className="relative h-full bg-white backdrop-blur-sm border border-gray-200/80 rounded-3xl p-8 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300">
                ...
                >
                  <div
                    className={`relative w-20 h-20 mx-auto rounded-2xl bg-gradient-to-br ${solution.gradient} p-0.5 shadow-md`}
                  >
                    <div className="w-full h-full bg-white rounded-2xl flex items-center justify-center">
                      <div
                        className={`w-16 h-16 rounded-xl bg-gradient-to-br ${solution.gradient}/10 flex items-center justify-center`}
                      >
                        <img
                          src={solution.icon}
                          alt={solution.title}
                ...
                >
                  <span
                    className={`bg-gradient-to-r ${solution.gradient} bg-clip-text`}
                  >
                    {solution.title}
                  </span>
                </motion.h3>
        ...
        >
          {[
            ...
            >
              ...
              <div className="text-gray-700 text-sm font-semibold relative z-10">
                {stat.label}
              </div>
              ...
              <div className="sticky top-0 bg-white border-b border-gray-200 p-6 flex justify-between items-center z-10">
                <div>
                  ...
                  <p className="text-gray-600">
                    Confirm your details to proceed with the loan application
                  </p>
                </div>
                <button
                  onClick={() => setShowEligibilityForm(false)}
                        ...
                        >
                          <div className="flex items-center">
                            ...
                            <span className="text-emerald-700 font-semibold">
                              All criteria confirmed! You're eligible to
                              proceed.
                            </span>
                          </div>
                        </motion.div>
                    ...
                    {isSubmitted ? (
                      ...
                      >
                        ...
                        <p className="text-gray-600 mb-6">
                          Your eligibility has been confirmed. Our team will
                          contact you shortly.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                          <button
                        ...
                        <div className="pt-4 space-y-4">
                          ...
                          >
                            {isAllConfirmed
                              ...
                              : "Confirm All Eligibility Criteria First"}
                          </motion.button>

                          {!isAllConfirmed && (
                            <p className="text-center text-gray-500 text-sm">
                              Please confirm all eligibility criteria before
                              proceeding.
                            </p>
                          )}
