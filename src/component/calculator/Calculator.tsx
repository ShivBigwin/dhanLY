...
export default function LoanCalculator() {
  ...
  const calculateEMI = () => {
    ...
    const principalPercentage = Math.round(
      (principal / totalPaymentValue) * 100,
    );
    const interestPercentage = Math.round(
      (totalInterestValue / totalPaymentValue) * 100,
    );
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Calculate your EMIs and understand the break-up of interest and
            principal payments with our interactive calculator
          </p>
        </motion.div>
          ...
          >
            ...
            <div className="bg-linear-to-br from-blue-600 to-cyan-500 rounded-2xl p-8 text-white shadow-xl">
              ...
              <p className="text-blue-100 mb-8">
                Per month for {loanTenure * 12} months
              </p>
                  ...
                  >
                    ...
                    <div className="flex items-start space-x-3 overflow-hidden">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-sm sm:text-xl font-semibold text-gray-900 break-words leading-tight">
                          {formatCurrency(item.value)}
                        </div>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-8 border border-blue-100">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Get personalized loan offers with competitive rates and flexible
              repayment options.
            </p>
